...
function App() {
  ...
  return (
    ...
    >
       ...
       <Link to="/home" style={{color:`${navBarColor}`, letterSpacing:"0.2ch", fontWeight:"700"}}  >Home</Link>
       <Link to="/projects" style={{color:`${navBarColor}`, letterSpacing:"0.2ch" , fontWeight:"700"}} >Projects </Link>
       <Link to="/contact" style={{color:`${navBarColor}`, letterSpacing:"0.2ch" , fontWeight:"700"}}>Contact </Link>
